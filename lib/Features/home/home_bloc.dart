...
import 'package:bloc_sample_code/data/grocery_data.dart';
import 'package:bloc_sample_code/data/wishlist_items.dart';
...
class HomeBloc extends Bloc<HomeEvent, HomeState> {
  ...
  FutureOr<void> homeInitialEvent(
    ...
    emit(HomeLoadedSuccessState(
        products: GroceryData.groceryProduct.map((e) => ProductDataModel(
            id: e['id'],
            name: e['name'],
            description: e['description'],
            price: e['price'],
            img_url: e['img_url'])).toList()));
  }
